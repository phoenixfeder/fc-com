                ...
                >
                  ...
                  <Grid item sm={12} md={12} lg={12}>
                    <FormControl fullWidth required error={false}>
                      ...
                      <Input
                        id="username-input" type="text" error={this.state.isInputInvalid} onChange={this.handleInputChange} value={this.state.username} startAdornment={
                  ...
                  <Grid item sm={12} md={12} lg={12}>
                    <FormControl fullWidth required error={false}>
                      ...
                      <Input
                        id="password-input" type="password" error={this.state.isInputInvalid} onChange={this.handleInputChange} value={this.state.password} startAdornment={
                        <InputAdornment position="start">
                          <PasswordIcon />
                        </InputAdornment>
                      }
                  ...
                  <Grid item sm={12} md={12} lg={12} style={{ alignSelf: 'center' }}>
                    <div className={classes.wrapper}>
                      <Button
                        id="login-button" variant="contained" color="primary" disabled={this.props.loading}
