...
public enum StatusCode {
    ...
    USERENABLEDERROR(410, "USER IS ENABLED"),
    WRONGPASSWORDERROR(411, "WRONG PASSWORD"),
    USERNOTFOUNDERROR(412, "USER NOT FOUND"),

    FORMATERROR(500, "OBJECT FORMAT ERROR"),
    MISSINGPARAMS(501, "MISSING REQUEST PARAMETERS"),
