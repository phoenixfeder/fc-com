...
(1, 'testuser', 'test.user@fc.de', '$2a$10$gba/UpsDbHZmPCMUS4LkEeO8fY53BmGfmNgrObtWQ8zcW1BYWC/Im', 1, false, '2000-01-01'),
(2, 'expireduser', 'expired.user@fc.de', '$2a$10$cibeyz8xZSR5Ohc.hA7n6ePfsWagaOk.VHa8VGICBiwvPywRSYttm', 1, false, '1987-03-25'),
(3, 'enableduser', 'enabled.user@fc.de', '$2a$10$cibeyz8xZSR5Ohc.hA7n6ePfsWagaOk.VHa8VGICBiwvPywRSYttm', 1, true, '1980-04-28'),
(4, 'admin', 'admin.user@fc.de','$2a$10$cibeyz8xZSR5Ohc.hA7n6ePfsWagaOk.VHa8VGICBiwvPywRSYttm', 2, true, '1999-04-01');
